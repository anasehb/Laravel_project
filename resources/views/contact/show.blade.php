            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('contact.submit') }}">
                        ...
                        <div class="row mb-3">
                            <label for="email" class="col-md-4 col-form-label text-md-end">Je email</label>
                        ...
                        <div class="row mb-3">
                            <label for="content" class="col-md-4 col-form-label text-md-end">Bericht</label>

                            <div class="col-md-6">
                                <textarea id="content" class="form-control @error('content') is-invalid @enderror" name="content" required autofocus></textarea>
